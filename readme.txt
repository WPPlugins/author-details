...
Tags: author details, about author, author bio, author profile at end of post, profiles, gravatar, EDC
...
Author Details plugin displays the author details at the end of the post.
...
Find out more at http://www.islam.com.kw/DawahApps/

Support Us and make a donation at http://www.islam.com.kw/DawahApps/

== Installation ==

This section describes how to install the plugin and get it working.

1. Upload the folder `author-details` to the `/wp-content/plugins/` directory.
...
1. Author Details Display. This is the default layout; you have full control on what you put in there.
...
= 1.1 =
* Check and insert data by username author.
